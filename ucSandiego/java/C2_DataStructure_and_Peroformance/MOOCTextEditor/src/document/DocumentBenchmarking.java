...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double basicDocEstTime = (basicDocEndTime - basicDocStartTime) / 1000000000.0;
			System.out.print(basicDocEstTime + "\t");
			...
			double efficientDocEstTime = (efficientDocEndTime - efficientDocStartTime) / 1000000000.0;
			System.out.println(efficientDocEstTime);
		}
