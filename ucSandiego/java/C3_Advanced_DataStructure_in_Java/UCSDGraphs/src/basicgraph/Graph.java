...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		// TODO: Implement in part 1 of week 2
		List<Integer> degreeSeq = new ArrayList<>();

		for (int i = 0; i < getNumVertices(); i++)
			degreeSeq.add(getInNeighbors(i).size() + getNeighbors(i).size());
	...
	public static void main (String[] args) {
		...
		//GraphLoader.createIntersectionsFile("data/maps/suj.map", "data/intersections/suj.intersections");
		...
		// my test cases
		System.out.println("Test on UCSD");
