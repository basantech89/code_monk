...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	private void colorDetermine(PGraphics pg) {
		...
		if (depth >= THRESHOLD_DEEP) pg.fill(255, 0, 0); // DEEP red: > 300
		else if (depth >= THRESHOLD_INTERMEDIATE) pg.fill(0 ,0, 255); // INTERMEDIATE blue: < 300
		else pg.fill(255, 255, 0); // SHALLOW yellow: < 70
	}
	...
	public String getAge() { return getProperty("age").toString(); }
}
