                ...
                <Card>
                    ...
                    <CardImgOverlay>
                        <Button outline color="primary"
                                onClick={() => favorite ? console.log('Already favorites') : postFavorite(dish.id)}>
                            ...
                            return(
                                <Fade in key={comment.id}>
                                    <li>
                                        ...
                                        <p> -- {comment.customer.firstname ?
                                            comment.customer.firstname : comment.customer.username} {comment.customer.lastname},
                                            {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day:'2-digit'}).format(new Date(Date.parse(comment.updatedAt)))} </p>
                                    </li>
                                </Fade>
                            )
                        })}
