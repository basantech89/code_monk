...
def draw(canvas):
    ...
    canvas.draw_image(debris_image, center, size, (wtime + WIDTH / 2, HEIGHT / 2), (WIDTH, HEIGHT))
    canvas.draw_text("Lives 3", (10, 40), 20, "White", "monospace")
    canvas.draw_text("Score 0", (WIDTH - 100, 40), 20, "White", "monospace")
...
def rock_spawner():
    ...
    a_rock.vel[0] = random.random() * .6 - .3
    a_rock.vel[1] = random.random() * .6 - .3
    a_rock.angle_vel, a_rock.angle = random.random() * .2 - .1, random.randrange(0, 361)
