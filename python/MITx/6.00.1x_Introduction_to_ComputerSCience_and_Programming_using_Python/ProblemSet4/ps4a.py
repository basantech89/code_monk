...
WORDLIST_FILENAME = "E:/ProblemSet4/words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    if word == '' or word not in wordList:
        return False
    for char in word:
        if char not in hand or hand2[char] == 0:
            return False
        else:
            hand2[char] -= 1
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    print 'Run out of letters or you entered a period. Total score is :',score,' points.' 
#
