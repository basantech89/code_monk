...
class WeightedEdge(Edge):
    def __init__(self, src, dest, traversed_dist, outdoor_dist):
        Edge.__init__(self, src, dest)
        self.traversed_dist = traversed_dist
        self. outdoor_dist = outdoor_dist
    def getTotalDistance(self):
        return self.traversed_dist
    def getOutdoorDistance(self):
        return self.outdoor_dist
    def __str__(self):
        return '{0}->{1} ({2}, {3})'.format(self.src, self.dest,\
                self.traversed_dist, self.outdoor_dist)
